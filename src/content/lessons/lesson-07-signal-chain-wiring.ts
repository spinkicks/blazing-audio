...
const FULL_SYSTEM: PatchBox[] = [
  ...
  },
  {
    ...
    h: 22,
    ports: [
      { id: 'full.preInL', label: 'in L', x: 30, y: 13, color: 'white' },
      { id: 'full.preInR', label: 'in R', x: 30, y: 19, color: 'red' },
      { id: 'full.preOutL', label: 'out FL', x: 54, y: 11, color: 'white' },
      { id: 'full.preOutR', label: 'out FR', x: 54, y: 17, color: 'red' },
      { id: 'full.preOutSub', label: 'out SUB', x: 54, y: 23, color: 'blue' },
    ],
  },
  {
    id: 'amp',
    ...
    h: 34,
    ports: [
      { id: 'full.ampInL', label: 'in FL', x: 70, y: 10, color: 'white' },
      { id: 'full.ampInR', label: 'in FR', x: 70, y: 16, color: 'red' },
      { id: 'full.ampInSub', label: 'in SUB', x: 70, y: 22, color: 'blue' },
      { id: 'full.ampL+', label: 'FL+', x: 90, y: 9, color: 'red' },
      { id: 'full.ampL-', label: 'FL-', x: 90, y: 14, color: 'black' },
      { id: 'full.ampR+', label: 'FR+', x: 90, y: 21, color: 'red' },
      { id: 'full.ampR-', label: 'FR-', x: 90, y: 26, color: 'black' },
      { id: 'full.ampSub+', label: 'SUB+', x: 90, y: 31, color: 'red' },
      { id: 'full.ampSub-', label: 'SUB-', x: 90, y: 36, color: 'black' },
    ],
  },
  {
    id: 'left',
