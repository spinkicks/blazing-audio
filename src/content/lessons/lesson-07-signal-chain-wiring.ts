...
const AMP_3CH: PatchBox[] = [
  {
    ...
    h: 44,
    ports: [
      { id: 'amp.fl+', label: 'FL+', x: 42, y: 20, color: 'red' },
      { id: 'amp.fl-', label: 'FL-', x: 42, y: 27, color: 'black' },
      { id: 'amp.fr+', label: 'FR+', x: 50, y: 20, color: 'red' },
      { id: 'amp.fr-', label: 'FR-', x: 50, y: 27, color: 'black' },
      { id: 'amp.sub+', label: 'SUB+', x: 58, y: 20, color: 'red' },
      { id: 'amp.sub-', label: 'SUB-', x: 58, y: 27, color: 'black' },
    ],
  },
  {
    id: 'left',
    ...
    h: 20,
    ports: [
      { id: 'left+', label: '+', x: 18, y: 22, color: 'red' },
      { id: 'left-', label: '-', x: 18, y: 29, color: 'black' },
    ],
  },
  {
    id: 'right',
    ...
    h: 20,
    ports: [
      { id: 'right+', label: '+', x: 82, y: 22, color: 'red' },
      { id: 'right-', label: '-', x: 82, y: 29, color: 'black' },
    ],
  },
  {
    id: 'sub',
    ...
    h: 5,
    ports: [
      { id: 'sub+', label: '+', x: 45, y: 58, color: 'red' },
      { id: 'sub-', label: '-', x: 55, y: 58, color: 'black' },
    ],
  },
];
...
const FULL_SYSTEM: PatchBox[] = [
  {
    ...
    h: 12,
    ports: [
      { id: 'full.phoneL', label: 'L', x: 17, y: 8, color: 'white' },
      { id: 'full.phoneR', label: 'R', x: 17, y: 13, color: 'red' },
    ],
  },
  {
    id: 'pre',
    ...
    h: 22,
    ports: [
      { id: 'full.preInL', label: 'in L', x: 32, y: 10, color: 'white' },
      { id: 'full.preInR', label: 'in R', x: 32, y: 16, color: 'red' },
      { id: 'full.preOutL', label: 'out FL', x: 58, y: 8, color: 'white' },
      { id: 'full.preOutR', label: 'out FR', x: 58, y: 14, color: 'red' },
      { id: 'full.preOutSub', label: 'out SUB', x: 58, y: 20, color: 'blue' },
    ],
  },
  {
    id: 'amp',
    ...
    h: 42,
    ports: [
      { id: 'full.ampInL', label: 'in FL', x: 72, y: 8, color: 'white' },
      { id: 'full.ampInR', label: 'in FR', x: 72, y: 14, color: 'red' },
      { id: 'full.ampInSub', label: 'in SUB', x: 72, y: 20, color: 'blue' },
      { id: 'full.ampL+', label: 'FL+', x: 88, y: 9, color: 'red' },
      { id: 'full.ampL-', label: 'FL-', x: 88, y: 14, color: 'black' },
      { id: 'full.ampR+', label: 'FR+', x: 88, y: 21, color: 'red' },
      { id: 'full.ampR-', label: 'FR-', x: 88, y: 26, color: 'black' },
      { id: 'full.ampSub+', label: 'SUB+', x: 88, y: 33, color: 'red' },
      { id: 'full.ampSub-', label: 'SUB-', x: 88, y: 38, color: 'black' },
    ],
  },
  {
    id: 'left',
    ...
    h: 12,
    ports: [
      { id: 'full.left+', label: '+', x: 42, y: 52, color: 'red' },
      { id: 'full.left-', label: '-', x: 42, y: 57, color: 'black' },
    ],
  },
  {
    id: 'right',
    ...
    h: 12,
    ports: [
      { id: 'full.right+', label: '+', x: 56, y: 52, color: 'red' },
      { id: 'full.right-', label: '-', x: 56, y: 57, color: 'black' },
    ],
  },
  {
    id: 'sub',
