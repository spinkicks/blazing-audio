...
const LINE_CONVERTER: PatchBox[] = [
  {
    ...
    h: 22,
    ports: [
      { id: 'spk+', label: 'spk +', x: 26, y: 24, color: 'red' },
      { id: 'spk-', label: 'spk -', x: 26, y: 32, color: 'black' },
    ],
  },
  {
    id: 'converter',
    label: 'line converter',
    x: 40,
    y: 12,
    w: 28,
    h: 32,
    ports: [
      { id: 'conv.in+', label: 'in +', x: 42, y: 24, color: 'red' },
      { id: 'conv.in-', label: 'in -', x: 42, y: 33, color: 'black' },
      { id: 'conv.rca', label: 'RCA out', x: 66, y: 25, color: 'red' },
    ],
  },
  {
    id: 'sub',
    ...
    w: 22,
    h: 22,
    ports: [{ id: 'sub.rca', label: 'RCA in', x: 78, y: 31, color: 'red' }],
  },
];
